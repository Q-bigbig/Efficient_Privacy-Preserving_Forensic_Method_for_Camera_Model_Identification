function im_noise = noiseextractfromgrayscale(Im,sigma)

L=4;
qmf = MakeONFilter('Daubechies',8);
%sigma = 3*function_stdEst2D(Im,4);
...
[image_noise,L]=midwt(wave_trans,qmf,L);

% Crop to the original size
im_noise = image_noise(pr+1:pr+M,pc+1:pc+N);
